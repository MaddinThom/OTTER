...
int main() {
	...
	VertexArrayObject::sptr vao0 = ObjLoader::LoadFromFile("models/paddle.obj");
	VertexArrayObject::sptr vao1 = ObjLoader::LoadFromFile("models/ball.obj");
	VertexArrayObject::sptr vao2 = ObjLoader::LoadFromFile("models/brick.obj");
	VertexArrayObject::sptr vao3 = ObjLoader::LoadFromFile("models/ball.obj");
	/*********
	...
	********/
	...
	transforms[0]->SetLocalPosition(0.0f, 0.0f, 0.5f)->SetLocalRotation(00.0f, 0.0f, 0.0f);
	transforms[1]->SetLocalPosition(2.0f, 0.0f, 0.5f)->SetLocalRotation(00.0f, 0.0f, 0.0f);
	transforms[2]->SetLocalPosition(-2.0f, 0.0f, 0.5f)->SetLocalRotation(00.0f, 0.0f, 0.0f);
	...
	Texture2DData::sptr diffuseMap = Texture2DData::LoadFromFile("images/Diffuse_Paddle.png");
	...
	camera->SetPosition(glm::vec3(0, 5, 3)); // Set initial position
